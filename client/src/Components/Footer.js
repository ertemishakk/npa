                ...
                <div className=" text-center text-md-left">
                    <div className="row text-center text-md-left mt-3 pb-3">
                        <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                            <h6 className="text-uppercase mb-4 font-weight-bold">National Parks Australia</h6>
                            <p> We have a passion for the outdoors and believe it's our responsibility to promote, protect, and preserve public lands.

Each collection of quality goods is made with purpose and helps fund a project in our parks.
</p>
                        </div>
                        ...
                        <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                            ...
                            <p>
                                <i className="fas fa-envelope mr-3 text-dark"></i> admin@npa.com.au</p>
                            <p>
                    ...
                    <div className="row d-flex align-items-center">
                      ...
                      <a href="https://npa.com.au/">
                                    <strong className='text-dark'> npa.com.au</strong>
                                </a>
                            </p>
